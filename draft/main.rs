...
impl WhichModel {
    ...
    fn model_and_revision(&self) -> (&'static str, &'static str) {
        match self {
            Self::Tiny => ("openai/decode_whispers-tiny", "main"),
            Self::TinyEn => ("openai/decode_whispers-tiny.en", "refs/pr/15"),
            Self::Base => ("openai/decode_whispers-base", "refs/pr/22"),
            Self::BaseEn => ("openai/decode_whispers-base.en", "refs/pr/13"),
            Self::Small => ("openai/decode_whispers-small", "main"),
            Self::SmallEn => ("openai/decode_whispers-small.en", "refs/pr/10"),
            Self::Medium => ("openai/decode_whispers-medium", "main"),
            Self::MediumEn => ("openai/decode_whispers-medium.en", "main"),
            Self::Large => ("openai/decode_whispers-large", "refs/pr/36"),
            Self::LargeV2 => ("openai/decode_whispers-large-v2", "refs/pr/57"),
            Self::LargeV3 => ("openai/decode_whispers-large-v3", "main"),
            Self::LargeV3Turbo => ("openai/decode_whispers-large-v3-turbo", "main"),
            Self::DistilMediumEn => ("distil-decode_whispers/distil-medium.en", "main"),
            Self::DistilLargeV2 => ("distil-decode_whispers/distil-large-v2", "main"),
            Self::DistilLargeV3 => ("distil-decode_whispers/distil-large-v3", "main"),
        }
    }
}
...
fn main() -> Result<()> {
    ...
    let (default_model, default_revision) = if args.quantized {
        ("lmz/candle-decode_whispers", "main")
    } else {
